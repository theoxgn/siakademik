    ...
    <div class="col-md-8 offset-md-2 widget-holder">
      <div class="widget-bg">
        <div class="widget-body clearfix">
          <h5 class="box-title mr-b-0">Tambah Bidang Perkembangan</h5>
          <p class="text-muted">Pastikan data bidang perkembangan benar</p>
          <form id="form-pendaftaran">
            <div class="form-group">
              <label for="l38">NAMA Bidang</label>
              <input class="form-control" name="NAMA_BIDANG" type="text" placeholder="Masukkan Nama Bidang Perkembangan">
            </div>
...
<script>
  $("#form-pendaftaran").on('submit', (e) => {
    ...
    $.ajax({
      type: "POST",
      url: "<?= base_url(); ?>api/tambah/bidang",
