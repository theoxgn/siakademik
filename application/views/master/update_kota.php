    ...
    <div class="col-md-8 offset-md-2 widget-holder">
      <div class="widget-bg">
        <div class="widget-body clearfix">
          <h5 class="box-title mr-b-0">Update Kota</h5>
          <p class="text-muted">Pastikan data kota benar</p>
          <form id="form-pendaftaran">
            <div class="form-group">
              <label for="l38">NAMA KOTA</label>
              <input class="form-control" name="NAMA_KOTA" type="text" placeholder="Masukkan Nama Kota" value="<?= $kota->NAMAKOTA ?>">
            </div>
...
<script>
  $("#form-pendaftaran").on('submit', (e) => {
    ...
    $.ajax({
      type: "POST",
      url: "<?= base_url(); ?>api/update/kota/<?= $kota->IDKOTA ?>",
      ...
      success: (response) => {
        ...
        setTimeout(() => {
          ...
          if (response.success) {
            window.location.replace("<?= base_url(); ?>master/kota")
          }
